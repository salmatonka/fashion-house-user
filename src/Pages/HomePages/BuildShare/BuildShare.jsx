  ...
  return (
    ...
    <div className='bg-blue-200 '>
        <div className="p-5  sm:p-10 md:p-16  ">
            ...
            <h3 className='text-center text-3xl font-bold pt-0 pb-14 '>Product Ideas 2024</h3>
            ...
            <div data-aos="fade-down"
                ...
                <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-gray-50">
                    <div data-aos="zoom-in-up" className="space-y-2">
                        ...
                        <p className="text-xs text-gray-600">Right this way for the best
                         products of 2023! Find the perfect present for everyone on your
                          list this year, no matter your budget. Browse Product guides
                           for her, the guys, teens, pets, and more. Or, get ideas for 
                           a unique product like a Christmas advent calendar.
                        </p>
                    </div>
                </div>
            </div>
